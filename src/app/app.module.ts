...
import { UniverseHttpService } from './shared/services/universe-http.service';

// Mock Services
import { MockScriptsProfileHttpService } from './mock/mockServices/mock-scripts-profile-http.service';
import { MockUniverseHttpService } from './mock/mockServices/mock-universe-http.service';
...
@NgModule({
  ...
  providers: [
    ...
    UniverseService,
    { provide: UniverseHttpService, useClass: MockUniverseHttpService }
  ],
